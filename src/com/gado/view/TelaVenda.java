...
import ServiceInterfaceImpl.GadoServiceImpl;
import ServiceInterfaceImpl.ProprietarioServiceImpl;
import ServiceInterfaceImpl.TransferenciaServiceImpl;
...
public class TelaVenda extends javax.swing.JFrame {
    ...
    public TelaVenda() {
        ...
        /*
                       VendedorService servicev = new VendedorServiceImp();

        for (Vendedores v : servicev.FindAllCB()) {

            cbVendedor.addItem(v);
        }
        */
        
        ProprietarioService pService = new ProprietarioServiceImpl();
        
        for(Proprietario p: pService.FindALL("Proprietario")){
            
            jComboBoxComprador.addItem(p);
        }
        
        GadoService gService = new GadoServiceImpl();
        
        for(Gado g: gService.FindALL("Gado")){
    ...
    public void readTable(){
        ...
        for (Object o : service.findByVenda()){
    ...
    public void cadastraVenda(){
        ...
        Transferencia t = new Transferencia();
        TransferenciaService tService = new TransferenciaServiceImpl();
